...
--
-- Table structure for table `constellation_boundaries`
--

DROP TABLE IF EXISTS `constellation_boundaries`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `constellation_boundaries` (
  `cb_id` int(11) NOT NULL AUTO_INCREMENT,
  `RA_low` decimal(65,30) DEFAULT NULL,
  `RA_up` decimal(65,30) DEFAULT NULL,
  `DE_low` decimal(65,30) DEFAULT NULL,
